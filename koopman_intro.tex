...
% TODO: check on what the answer should be here...

%TODO: finish writing this part. Should also maybe note the effect this has on what the best prediction of future coordinates should be given the current coordinates.
